...
import com.macro.mall.portal.component.RocketMQCancelOrderSender;
...
public class OmsPortalOrderServiceImpl implements OmsPortalOrderService {
    ...
    @Override
    @Transactional
    public Map<String, Object> generateSeckillOrder(Long memberId, Long productId, BigDecimal seckillPrice) {
        Map<String, Object> result = new HashMap<>();
        ...
        // 设置收货地址（使用默认地址）
        UmsMemberReceiveAddress address = memberReceiveAddressService.list().stream()
        ...
        orderItem.setProductPrice(seckillPrice);
        orderItem.setProductQuantity(1);
        orderItem.setProductSkuId(0L);
        ...
        orderItem.setRealAmount(seckillPrice);
        ...
        result.put("payAmount", seckillPrice);
