...
public class PmsPortalProductServiceImpl implements PmsPortalProductService {
    ...
    public PmsPortalProductDetail detail(Long id) {
        String cacheKey = redisDatabase + ":product:detail:" + id;
        String bloomFilterName = "product";
        
        // 使用缓存服务：带布隆过滤器保护
        PmsPortalProductDetail result = cacheService.getWithBloomFilter(
                cacheKey,
                bloomFilterName,
                id.toString(),
